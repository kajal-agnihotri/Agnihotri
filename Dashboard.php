...
if(isset($_SESSION['id'])){
	$id = $_SESSION['id'];
   $user = mysqli_fetch_assoc(mysqli_query($conn, "select * from assdt_users where id = '$id'"));
 }//else{
// 	header("location:Assessment/qone.php");
// }
?> 
<!DOCTYPE html>
<head>
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								<a href="#">
									...
									<span class="subject">
										<span class="from"><?php echo $sidebar['tab_name'];?></span>
